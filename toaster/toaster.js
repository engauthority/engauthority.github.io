...
const FOMO_CONFIG = [
  ...
  makeCompanyIpadPromoConfig(
    "amazon",
    "Amazon",
    g_analytics.engauthority_amazon_ipad_sales
  ),
  makeCompanyIphonePromoConfig(
    "amazon",
    "Amazon",
    g_analytics.engauthority_amazon_iphone_sales
  ),
  ...
  makeCompanyIpadPromoConfig(
    "apple",
    "Apple",
    g_analytics.engauthority_apple_ipad_sales
  ),
  makeCompanyIphonePromoConfig(
    "apple",
    "Apple",
    g_analytics.engauthority_apple_iphone_sales
  ),

  // End company-specific landing pages

  // Begin other pages/promos
...
*/
function makeCompanyPromoToasts(companyName, giftName, numSales) {
  return [
 ...
 * iPad promotion.
 * `checkoutPage` is optional, it's unused
 */
...
function makeCompanyIphonePromoConfig(
  ...
  return {
    ...
    toasts: makeCompanyPromoToasts(companyName, "free iPhone 13 Pro", numSales),
  };
}
